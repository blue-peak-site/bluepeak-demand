  ...
  const nextSteps = [
    {
      ...
      description: "Our team manually reviews your profile and local market data.",
      icon: Activity
    },
    {
      title: "Practical Review",
      description: "You'll receive a clear report with prioritized improvements.",
      icon: BarChart3
    },
    {
      title: "No Obligation",
      description: "The audit is yours to keep, with no pressure to move forward.",
      icon: Globe
    }
  ];
      ...
      <div className="relative z-10 flex flex-col gap-16 lg:gap-24 pb-32 pt-12 lg:pt-20">
        ...
        <section className="px-6 max-w-5xl mx-auto w-full text-center">
          ...
          >
            ...
            <h1 className="text-4xl md:text-5xl lg:text-7xl font-bold leading-[1.05] text-bp-white mb-8 tracking-tight">
              See Where Your <span className="text-bp-cta text-glow">Google Maps Profile</span> May Be Losing Calls
            </h1>
            
            <p className="text-lg md:text-xl text-bp-support mb-8 max-w-3xl mx-auto leading-relaxed">
              Get a manual, expert review of your local visibility. We identify the exact gaps preventing roofing companies from dominating their service areas.
            </p>
        ...
        <section className="px-6 max-w-7xl mx-auto w-full grid lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          ...
          >
            <div className="glass-card p-8 lg:p-10 border-white/10 relative overflow-hidden group">
              ...
              <h2 className="text-2xl lg:text-3xl font-bold text-bp-white mb-8">What Your Audit Covers</h2>
              ...
              <div className="space-y-8">
                {auditItems.map((item, i) => (
                  ...
                  >
                    ...
                    <div>
                      <h3 className="text-bp-white font-bold text-lg mb-1">{item.title}</h3>
                      <p className="text-bp-support text-sm leading-relaxed opacity-70">{item.description}</p>
                    </div>
                  </motion.div>
                ))}
              </div>
              ...
              <div className="mt-12 pt-8 border-t border-white/5">
                <p className="text-bp-support text-sm leading-relaxed italic opacity-60">
                  "You'll receive a practical review of where your profile may be underperforming and what to improve first."
                </p>
              </div>
            </div>
          </motion.div>
            ...
            <div className="glass-card p-8 lg:p-12 border-white/20 shadow-2xl relative overflow-hidden">
              ...
              {isSubmitted ? (
                ...
                >
                  ...
                  <h3 className="text-3xl font-bold text-bp-white mb-4">Audit Requested</h3>
                  <p className="text-bp-support text-lg max-w-md mx-auto">
                    Thank you. Our specialists are now reviewing your profile. You'll receive your manual audit via email within 24-48 hours.
                  </p>
                  <Button 
                    variant="secondary" 
                    className="mt-10"
                ...
                <div className="relative z-10">
                  <div className="mb-10">
                    ...
                    <h3 className="text-2xl lg:text-3xl font-bold text-bp-white mb-4">Get Your Free Audit</h3>
                    <p className="text-bp-support text-sm leading-relaxed opacity-70">
                      A weak Google profile can quietly cost roofing companies calls. Fill out the details below to see exactly where you stand.
                    </p>
                  </div>
                  ...
                  <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                    <div className="grid md:grid-cols-2 gap-6">
                      <div className="space-y-2">
                        <label className="text-[10px] font-bold uppercase tracking-widest text-bp-support/60 ml-1">Name</label>
                        <input 
                          type="text" 
                          required
                          onFocus={() => setFocusedField('name')}
                          onBlur={() => setFocusedField(null)}
                          className={`w-full bg-white/5 border ${focusedField === 'name' ? 'border-bp-cta/50 bg-white/10' : 'border-white/10'} rounded-xl px-5 py-4 text-bp-white placeholder:text-bp-support/30 focus:outline-none transition-all duration-300`}
                          placeholder="Your Name"
                        />
                      </div>
                      <div className="space-y-2">
                        <label className="text-[10px] font-bold uppercase tracking-widest text-bp-support/60 ml-1">Company</label>
                        <input 
                          type="text" 
                          required
                          onFocus={() => setFocusedField('company')}
                          onBlur={() => setFocusedField(null)}
                          className={`w-full bg-white/5 border ${focusedField === 'company' ? 'border-bp-cta/50 bg-white/10' : 'border-white/10'} rounded-xl px-5 py-4 text-bp-white placeholder:text-bp-support/30 focus:outline-none transition-all duration-300`}
                    ...
                    <div className="space-y-2">
                      <label className="text-[10px] font-bold uppercase tracking-widest text-bp-support/60 ml-1">Email</label>
                      <input 
                        type="email" 
                        required
                        onFocus={() => setFocusedField('email')}
                        onBlur={() => setFocusedField(null)}
                        className={`w-full bg-white/5 border ${focusedField === 'email' ? 'border-bp-cta/50 bg-white/10' : 'border-white/10'} rounded-xl px-5 py-4 text-bp-white placeholder:text-bp-support/30 focus:outline-none transition-all duration-300`}
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                      <div className="space-y-2">
                        <label className="text-[10px] font-bold uppercase tracking-widest text-bp-support/60 ml-1">City / Service Area</label>
                        <input 
                          type="text" 
                          required
                          onFocus={() => setFocusedField('city')}
                          onBlur={() => setFocusedField(null)}
                          className={`w-full bg-white/5 border ${focusedField === 'city' ? 'border-bp-cta/50 bg-white/10' : 'border-white/10'} rounded-xl px-5 py-4 text-bp-white placeholder:text-bp-support/30 focus:outline-none transition-all duration-300`}
                          placeholder="e.g. Dallas, TX"
                        />
                      </div>
                      <div className="space-y-2">
                        <label className="text-[10px] font-bold uppercase tracking-widest text-bp-support/60 ml-1">Website</label>
                        <input 
                          type="url" 
                          onFocus={() => setFocusedField('website')}
                          onBlur={() => setFocusedField(null)}
                          className={`w-full bg-white/5 border ${focusedField === 'website' ? 'border-bp-cta/50 bg-white/10' : 'border-white/10'} rounded-xl px-5 py-4 text-bp-white placeholder:text-bp-support/30 focus:outline-none transition-all duration-300`}
                    ...
                    <div className="space-y-2">
                      <label className="text-[10px] font-bold uppercase tracking-widest text-bp-support/60 ml-1">Google Business Profile Link (Optional)</label>
                      <input 
                        type="url" 
                        onFocus={() => setFocusedField('gbp')}
                        onBlur={() => setFocusedField(null)}
                        className={`w-full bg-white/5 border ${focusedField === 'gbp' ? 'border-bp-cta/50 bg-white/10' : 'border-white/10'} rounded-xl px-5 py-4 text-bp-white placeholder:text-bp-support/30 focus:outline-none transition-all duration-300`}
                        placeholder="Link to your Google Maps listing"
                      />
                    </div>

                    <div className="space-y-2">
                      <label className="text-[10px] font-bold uppercase tracking-widest text-bp-support/60 ml-1">Anything specific we should look at? (Optional)</label>
                      <textarea 
                        rows={3}
                        onFocus={() => setFocusedField('specifics')}
                        onBlur={() => setFocusedField(null)}
                        className={`w-full bg-white/5 border ${focusedField === 'specifics' ? 'border-bp-cta/50 bg-white/10' : 'border-white/10'} rounded-xl px-5 py-4 text-bp-white placeholder:text-bp-support/30 focus:outline-none transition-all duration-300 resize-none`}
                    ...
                    <div className="mt-4">
                      ...
                      <p className="text-center text-[10px] text-bp-support/40 mt-4 uppercase tracking-[0.2em]">
                        No spam. No obligation. Just a practical review of your profile.
                      </p>
                    </div>
                  </form>
                </div>
        ...
        <section className="px-6 max-w-7xl mx-auto w-full pt-12 border-t border-white/5">
          ...
          >
            ...
            <p className="text-bp-support opacity-60">Our process is straightforward and focused on your results.</p>
          </motion.div>
