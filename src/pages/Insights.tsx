    ...
    <div className="flex flex-col gap-24 pb-32 pt-12 lg:pt-20 relative overflow-hidden">
            ...
            >
              ...
              >
                ...
                <div className="flex items-center justify-between mb-8 relative z-10">
                  <span className="text-[10px] font-bold uppercase tracking-[0.3em] text-bp-cta group-hover:tracking-[0.35em] transition-all duration-500">{article.category}</span>
                  <span className="text-[10px] text-bp-support flex items-center gap-1.5 opacity-60">
                    <Clock className="w-3 h-3" /> {article.readTime}
                  </span>
                </div>
                
                <h3 className="text-xl lg:text-2xl font-bold text-bp-white mb-8 group-hover:text-bp-cta transition-colors duration-500 leading-tight relative z-10">
                  {article.title}
                </h3>
      ...
      <section className="px-6 max-w-4xl mx-auto w-full text-center py-20 relative z-10">
        <div className="flex flex-col items-center gap-2 opacity-30">
          <span className="text-[10px] font-bold uppercase tracking-[0.5em] text-bp-white">BluePeak Demand Intelligence</span>
